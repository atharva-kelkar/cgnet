This figure appeared in the following article:
...
In additing to citing the article, if you wish to use this figure you must request permissions from ACS using [this link](https://pubs.acs.org/page/rightslinkno.jsp).
